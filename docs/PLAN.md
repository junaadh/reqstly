...
### Phase 3 progress checklist (March 5, 2026)
...
3. Add frontend CI gates (`bun install`, `bun run check`, `bun run build`) in `.github/workflows/ci.yml`.
4. Finish passkey first-factor sign-in reliability hardening and keep fallback path documented.
5. Implement and wire missing profile/settings persistence APIs.
